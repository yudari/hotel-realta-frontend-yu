...
const ModalAddItem: NextPage<ModalAddItemType> = ({ onClose }) => {
  return (
    <div className="relative rounded bg-neutrals shadow-[0px_5px_10px_rgba(62,_19,_77,_0.47)] w-[517px] h-[389px] overflow-hidden max-w-full max-h-full text-left text-sm text-neutrals font-body-txt-body-s-regular">
      <div className="absolute top-[0px] left-[0px] bg-darkslategray-300 w-[517px] overflow-hidden flex flex-row py-[18px] px-[45px] box-border items-center justify-start text-3xl">
      ...
      <div className="absolute top-[97px] left-[45px] w-[398px] h-[74px] text-grayscale-border">
        ...
        <div className="absolute top-[0px] left-[0px] w-[117.98px] flex flex-row items-start justify-start text-base text-grayscale-black">
      ...
      <div className="absolute top-[193px] left-[45px] w-[398px] h-[77px] text-grayscale-border">
        ...
        <div className="absolute top-[0px] left-[0px] w-[167.7px] h-6 text-base text-grayscale-black">
      ...
      <div className="absolute top-[303px] left-[261px] w-[182px] h-[34px] text-center">
        ...
        <button
          ...
          onClick={onClose}
        >
          <div className="relative text-sm leading-[140%] font-body-txt-body-s-regular text-brown text-center">
            Cancel
          </div>
        </button>
      </div>
