...
const SectionRooms: NextPage<InterfaceSectionRooms> = (props) => {
  ...
  return (
    <div className="self-stretch flex flex-col py-0 px-[92px] items-start justify-start text-left text-xl text-darkslategray-300 font-body-txt-body-s-regular">
      <div className="self-stretch flex flex-col items-start justify-start gap-[16px]">
        ...
        <div className="self-stretch flex flex-col items-start justify-start gap-[32px]">
          ...
          <div className="self-stretch flex flex-col items-start justify-start gap-[16px] text-base text-darkslategray-100">
