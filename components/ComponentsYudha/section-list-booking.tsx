              ...
              <div className="w-fit shrink-0 flex flex-col items-start justify-start ">
                ...
                <div className="input-price mt-2">
                  ...
                  <div className="relative mb-6">
                    ...
                    <input type="number" name="hargaAwal" id="input-group-1" className="bg-gray-50border-[1px] border-solid border-gray-300 text-gray-900 dark:text-white text-[14px] rounded-sm focus:ring-blue-500 focus:border-blue-500 block  pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="0"
