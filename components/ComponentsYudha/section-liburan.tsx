...
const SectionLiburan: NextPage = () => {
  ...
  return (
    <div className="self-stretch flex flex-col py-[42px] px-[92px] items-start justify-start text-left text-13xl text-darkslategray-300 font-body-txt-body-s-regular lg:pl-5 lg:pr-5 lg:box-border">
      <div
        ...
        data-animate-on-scroll
      >
        <div className="self-stretch flex flex-row items-center justify-start gap-[24px] sm:flex-col">
          <div className="flex-1 flex flex-col items-start justify-start gap-[16px] sm:flex-[unset] sm:self-stretch">
            <h3 className="m-0 self-stretch relative text-[inherit] font-bold font-inherit sm:text-9xl sm:text-center sm:self-stretch sm:w-auto">
              Jatuh Cinta pada Liburan
            </h3>
            <p className="m-0 self-stretch relative text-base sm:font-body-txt-body-s-regular sm:text-sm sm:text-center">
          ...
          <button className="cursor-pointer py-2 px-4 bg-[transparent] flex flex-col items-start justify-start border-[1px] border-solid border-darkslategray-300 hover:bg-darkslategray-300 hover:text-neutrals hover:cursor-pointer">
            <div className="relative text-sm font-medium font-montserrat-semibold-14 text-darkslategray-300 text-left">
              See All
            </div>
          </button>
        </div>
        <div className="flex flex-row items-start justify-start gap-4 text-xl text-neutrals lg:flex-row lg:flex-wrap lg:justify-center">
          <div className="relative rounded-xl w-[302px] h-[420px] overflow-hidden">
