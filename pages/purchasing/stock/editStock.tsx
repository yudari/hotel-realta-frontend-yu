...
export default function EditStock(props: any) {
  ...
  const [data, setData] = useState<any>(props.dataStock);
  ...
  const handleSave = async (data: FormValues) => {
    try {
      ...
      dispatch(doUpdateStock(props.isEdit.id, data));
      props.closeModal();
    } catch (error) {
      console.error(error);
    }
  ...
  console.log("Datastock;", props.dataStock);
                  ...
                  <div className="mt-4">
                    <form onSubmit={handleSubmit(handleSave, handleError)}>
                      <div className="w-full mb-4">
                        ...
                        <input className="flex-1 shadow appearance-none border rounded w-full py-3 px-1 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="stock_name" type="text" defaultValue={data?.stock_name ?? ""} {...register("stock_name", registerOptions.stock_name)} />
                      ...
                      <div className="w-full mb-4">
                        ...
                        <input className="flex-1 shadow appearance-none border rounded w-full py-3 px-1 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="stock_description" type="text" defaultValue={data?.stock_description ?? ""} {...register("stock_description", registerOptions.stock_description)} />
                      ...
                      <div className="flex flex-wrap -mx-4">
                        <div className="w-full md:w-1/2 px-4 mb-4">
                          ...
                          <input className="shadow appearance-none border rounded w-full py-3 px-1 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="qty" type="number" defaultValue={data?.stock_quantity ?? ""} {...register("stock_quantity", registerOptions.stock_quantity)} />
                        ...
                        <div className="w-full md:w-1/2 px-4 mb-4">
                          ...
                          <input className="shadow appearance-none border rounded w-full py-3 px-1 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="stock_reorder_point" type="number" defaultValue={data?.stock_reorder_point ?? ""} {...register("stock_reorder_point", registerOptions.stock_reorder_point)} />
                        ...
                        <div className="w-full md:w-1/2 px-4 mb-4">
                          ...
                          <input className="shadow appearance-none border rounded w-full py-3 px-1 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="stock_used" type="number" defaultValue={data?.stock_used ?? ""} {...register("stock_used", registerOptions.stock_used)} />
                        ...
                        <div className="w-full md:w-1/2 px-4 mb-4">
                          ...
                          <input className="shadow appearance-none border rounded w-full py-3 px-1 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="stock_scrap" type="number" defaultValue={data?.stock_scrap ?? ""} {...register("stock_scrap", registerOptions.stock_scrap)} />
                        ...
                        <div className="w-full md:w-1/2 px-4 mb-4">
                          ...
                          <input className="shadow appearance-none border rounded w-full py-3 px-1 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="stock_size" type="text" defaultValue={data?.stock_size ?? ""} {...register("stock_size", registerOptions.stock_size)} />
                        ...
                        <div className="w-full md:w-1/2 px-4 mb-7">
                          ...
                          <input className="shadow appearance-none border rounded w-full py-3 px-1 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="color" type="text" defaultValue={data?.stock_color ?? ""} {...register("stock_color", registerOptions.stock_color)} />
