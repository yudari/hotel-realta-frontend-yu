...
import actionType from '../payment/action/actionType';
import { handleAddBank, handleDeleteBank, handleGetBank, handleUpdateBank } from '../payment/paymentSaga/bankSaga';
import { handleAddFintech, handleDeleteFintech, handleGetFintech, handleUpdateFintech } from '../payment/paymentSaga/fintechSaga';
import { handleGetPayTrans, handleTopup } from '../payment/paymentSaga/paymentTransactionSaga';
import { handleDeleteUserAcc, handleGetBankFintech, handleGetUserAcc, handleUpdateUserAcc, hanleAddUserAcc } from '../payment/paymentSaga/userAccountSaga';
